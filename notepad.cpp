...
行程
    {2017-10-19 15:25 大连周水子几场 17:25 浦东机场T2 厦门航空 MF8058}去上海 1 天
    {2017-10-20}下午去浙江义乌，晚上在义乌过夜
    {2017-10-21}走访义乌国际商贸城，晚上在义乌过夜
    {2017-10-22}22号回上海，从上海出发回大连
目的
    考察上海展
    考察小商品市场
结果
    寻找20样礼品：供应商、价格、备货期、起订量、厂址、税点、定制LOGO
    寻找毛绒玩具：供应商、价格、备货期、起订量、厂址、税点、包装、吊牌、LOGO
问题
    寻找毛绒玩具没有目标客户
